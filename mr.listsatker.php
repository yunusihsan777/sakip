...
<table width="100%"  border="0" cellspacing="4" cellpadding="4">
  <tr>
    <td><div align="center"><strong>DATA PERENCANAAN AKIP SATUAN KERJA KEJAKSAAN RI</strong></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
$start = $hits*($page-1);
$kueri = mysqli_query($link, "SELECT * FROM $tables where id_kejati = '$idkejati1'");
$data = array ();
...
<td width="10%"><center>Perjanjian Kinerja</center></td>
<td width="15%"><center>Jumlah Indikator Kinerja</center></td>
...
');
$no=1; $x=0;
$result = mysqli_query($link, "SELECT * FROM $tables where id_kejati = '$idkejati1' LIMIT $start,$hits");
...
print ('<center><b><a href="KEP/'.$keps2['id_filesurat'].'" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');  
} 
}
print ('</center></td>');
//-------------
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=renstra" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');  
} 
print ('</center></td>');
//=---------
//renja
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=renja" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//=---------
//tap kinerja
print ('<td><center>');
$tapker = mysqli_query($link, "SELECT * FROM sinori_sakip_penetapan where id_satker = '".$ar['id_satker']."'");
$datatapker = array ();
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=pk" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//-------------
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=iku" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//-------------
//DIPA
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=dipa" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//-------------
//REN AKSI
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=renaksi" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//-------------
...
print ('<center><b><a href="view.php?satker='.$ar['id_satker'].'&do=lkjip" target="_blank"><img src="images/centang.png" width="30" height="30"></a></b></center>');
} 
print ('</center></td>');
//=---------
...
?></td>
  ...
  <tr>
    <td>Aplikasi Serenata AKIP dibuat oleh Chendia Studio Jogjakarta</td>
  </tr>
</table>
