...
<div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:160px">
  ...
  <button class="w3-bar-item w3-button tablink" onclick="openCity(event, 'renaksi')">Evaluasi Ren Aksi</button>
...
$start = $hits*($page-1);
$kueri = mysqli_query($link, "SELECT * FROM $tables where id_satker = '$idsatker1' and id_otentikasi_tw1 ='1' and id_otentikasi_tw2 ='1' and id_otentikasi_tw3 ='1' and id_otentikasi_tw4 ='1'");
$data = array ();
...
');
$no=1; $x=0;
$result = mysqli_query($link, "SELECT * FROM $tables where id_satker = '$idsatker1' and id_otentikasi_tw1 ='1' and id_otentikasi_tw2 ='1' and id_otentikasi_tw3 ='1' and id_otentikasi_tw4 ='1' ORDER by id_bidang LIMIT $start,$hits");
