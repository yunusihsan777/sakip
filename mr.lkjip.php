  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td><table width="100%"  border="0" cellspacing="4" cellpadding="4">
        <tr>
          <td><div align="center"><strong>UPLOAD LAPORAN KINERJA INSTANSI PEMERINTAH (LKjIP) SATKER ANDA </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">Satker ID : <?PHP echo $id = $_GET['idsatker']; ?>
                ...
                <input name="do" type="hidden" id="do" value="lkjip">
          ...
          <td><div align="center">
            <table width="100%"  border="0" cellspacing="4" cellpadding="4">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>Upload LKjIP satker anda </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td colspan="3"><p> <strong>Laporan Kinerja Instansi Pemerintah (LKjIP) </strong>adalah <strong>laporan kinerja tahunan yang berisi pertanggungjawaban kinerja suatu instansi dalam mencapai tujuan/sasaran strategis instansi </strong> </p>
                  </td>
                </tr>
              <tr>
                <td>&nbsp;</td>
