  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td><table width="100%"  border="0" cellspacing="4" cellpadding="4">
        <tr>
          <td><div align="center"><strong>UPLOAD PENETAPAN IKU SATKER ANDA </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">Satker ID : <?PHP echo $id = $_GET['idsatker']; ?>
                ...
                <input name="do" type="hidden" id="do" value="iku">
          ...
          <td><div align="center">
            <table width="100%"  border="0" cellspacing="4" cellpadding="4">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>Upload IKU Hanya Bisa dilakukan Satu Kali. Cek Lagi File dan pastikan  anda akan upload benar.</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
