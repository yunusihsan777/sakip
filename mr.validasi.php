  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td><table width="100%"  border="0" cellspacing="4" cellpadding="4">
        <tr>
          <td><div align="center"><strong>PERSETUJUAN PENETAPAN KINERJA TAHUNAN </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">Satker ID : <?PHP echo $id = $_GET['idsatker']; ?>
                ...
                <input name="do" type="hidden" id="do" value="rkt">
        ...
        <tr>
          <td><table width="60%"  border="0" align="center" cellpadding="4" cellspacing="4">
            ...
            <tr>
              <td><div align="center"><strong>PERNYATAAN TELAH DI REVIU INTERNAL SATKER </strong></div></td>
            </tr>
            <tr>
