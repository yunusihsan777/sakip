  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td><table width="100%"  border="0" cellspacing="4" cellpadding="4">
        <tr>
          <td><div align="center"><strong>MENU PENDAFTARAN AUDITOR </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">Satker ID : <?PHP echo $id = $_GET['idsatker']; ?>
                ...
                <input name="do" type="hidden" id="do" value="auditor">
          ...
          <td><div align="center">
            <table width="100%"  border="0" cellspacing="4" cellpadding="4">
              <tr>
                ...
                <td width="2%">:</td>
                <td width="74%"><input name="textfield" type="text" size="50"></td>
              </tr>
              <tr>
                <td width="19%">NIP</td>
                <td width="2%">:</td>
                <td><input name="textfield2" type="text" size="50"> 
...
$result1 = mysqli_query($link, "SELECT * FROM sinori_login where id_level = '1' and id_hidesatker ='0'");
while ($row1=mysqli_fetch_array($result1,MYSQLI_ASSOC))
{
print ('<option value="'.$row1['id'].'">'.$row1['satkernama'].'</option>');
}
?>
            </select></td>
              </tr>
