...
<table width="100%"  border="0" cellspacing="4" cellpadding="4">
  <tr>
    <td><div align="center"><strong>MENU ATUR SATUAN KERJA DILINGKUNGAN KEJAKSAAN RI </strong></div></td>
  </tr>
  <tr>
    <td><div align="center">DATA MASTERED TERKONEKSI OLEH BAGIAN ORGANISASI DAN TATA LAKSANA PADA BIRO PERENCANAAN </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><div align="right"><a href="mr.proses.1.atursatker.add.php?session=<?PHP echo $session1; ?>&idsatker=<?PHP echo $sid1; ?>" onclick="NewWindow(this.href,'mywin','1000','600','yes','center');return false" onfocus="this.blur()"><img src="images/input.png" width="181" height="45" border="0"></a><br>
    </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
