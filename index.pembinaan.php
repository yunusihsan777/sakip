...
win = window.open(mypage,myname,settings)
 ...
 <li> <a href="?g=proses6&i=mr&session=<?PHP echo $session1; ?>&nama=<?PHP echo $nama1; ?>&idsatker=<?PHP echo $sid1; ?>"><span class="fa fa-trophy mr-3"></span>6. Pemantauan dan Reviu </a></li>
  ...
  <li>
     ...
     <li>
            <a href="?g=pemantauan1&i=mr&session=<?PHP echo $session1; ?>&nama=<?PHP echo $nama1; ?>&idsatker=<?PHP echo $sid1; ?>"><span class="fa fa-cog mr-3"></span> Pemantauan & Reviu 1</a>
          </li>
<li>
            <a href="?g=pemantauan2&i=mr&session=<?PHP echo $session1; ?>&nama=<?PHP echo $nama1; ?>&idsatker=<?PHP echo $sid1; ?>"><span class="fa fa-cog mr-3"></span> Pemantauan & Reviu 2</a>
          </li>
    <li>
...
elseif($g1 == "pemantauan1"){ include("mr.pemantauanreviu1.php"); }
elseif($g1 == "pemantauan2"){ include("mr.pemantauanreviu2.php"); }
