  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td><table width="100%"  border="0" cellspacing="4" cellpadding="4">
        <tr>
          <td><div align="center"><strong>UPLOAD RENCANA STRATEGIS SATKER ANDA </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">Satker ID : <?PHP echo $id = $_GET['idsatker']; ?>
                ...
                <input name="do" type="hidden" id="do" value="renstra">
        ...
        <tr>
          <td><div align="center">
            <table width="100%"  border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td width="5%">&nbsp;</td>
                <td width="10%">Periode Renstra </td>
                <td width="2%">:</td>
                <td width="83%"><select name="periode" id="periode">
                  <option value="P1">Periode 2020 - 2024</option>
                  <option value="P2">Periode 2024 - 2029</option>
              ...
              <tr>
                ...
                Dimulai dari pilihan angka 0 untuk posting pertama kali </td>
              </tr>
              <tr>
                <td rowspan="2">&nbsp;</td>
                <td>File PDF </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>Upload Rencana Strategis Hanya Bisa dilakukan Satu Kali. Cek Lagi File dan pastikan  anda akan upload benar.</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
